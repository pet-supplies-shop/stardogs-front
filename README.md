...
<img src="./favicon.png" alt="Stardos" />
...
function onYouTubePlayerAPIReady() {
  ...
  new YT.Player('player', {
    videoId: 'a0rBbgh05oc', // 재생할 유튜브 영상 ID
    playerVars: {
      autoplay: true, // 자동 재생 유무
      loop: true, // 반복 재생 유무
      playlist: 'a0rBbgh05oc' // 반복 재생할 유튜브 영상 ID 목록
    },
    events: {
      // 영상이 준비되었을 때,
      ...
      <div class="contents__menu">
        <ul class="inner">
          <li>
            <h4>사료</h4>
            <ul>
              <li class="category" data-category="전연령용">전연령용</li>
              <li class="category" data-category="자견용">자견용</li>
              <li class="category" data-category="성견용">성견용</li>
              <li class="category" data-category="노견용">노견용</li>
              <li class="category" data-category="분유">분유</li>
            </ul>
          </li>
          <li>
            <h4>간식</h4>
